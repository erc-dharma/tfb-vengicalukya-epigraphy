...
You can consult the current state of the work on this repository at https://erc-dharma.github.io/tfb-vengicalukya-epigraphy/.
...
- Once you have done your `git push`, the XML files are validated against the Epidoc and Dharma RelaxNG with a CI service called Travis. This process is made possible with the existing `.travis.yml` file. **Do not delete or modify this file on your own.** You can access the resulting log [here](https://travis-ci.com/github/erc-dharma/tfb-vengicalukya-epigraphy)
